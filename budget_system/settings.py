...
SECRET_KEY = "django-insecure-guz-*84i#9soyyac)y+izlrr@)4&2a6$scp#1!cz$jgm)63v=("
...
CELERY_BEAT_SCHEDULE = {
    "check_and_update_campaign_spend": {
        "task": "budget.tasks.check_and_update_campaign_spend",
    ...
    "reactivate_eligible_campaigns": {
        "task": "budget.tasks.reactivate_eligible_campaigns",
        "schedule": crontab(minute=0, hour=0),  # Every day at 00:00 UTC
    },
    "enforce_dayparting": {
    ...
    "simulate_ad_spend": {
        "task": "budget.tasks.simulate_ad_spend",
        "schedule": crontab(minute=0),  # Every hour on the hour
    },
}
